#ifndef FJAPP_BUBBLENSG_MI
#define FJAPP_BUBBLENSG_MI
...
!*/
class TFJBubbleNSG_Solver_MI: public TFJBubbleNSG_Solver {
public:
...
protected:
	...
	vector_f		_Mmass;			// record mass
//	float_t			_tracked_Mmass;	 // use _tracked_mass instead
private:
...
public:		// override this two major functions !!!
...
public:
	...
	float_t			get_total_Mmass() { return sum(_Mmass); }
	float_t			get_Mmass_err() 
	{ return (get_total_Mmass()-_tracked_mass)/_tracked_mass; }
